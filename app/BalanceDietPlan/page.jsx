...
const DietPlan = () => {
    ...
    const dailyCalories = "2,500 to 3,000 calories"; // Adjust as needed
            ...
            <section className="w-full max-w-3xl px-4">
                <div className="text-center mb-12">
                    <div className="flex items-center justify-center mb-4">
                        ...
                        <h2 className="text-4xl font-bold text-[#E09145]">Diet Plans</h2>
                    </div>
                ...
                <div className="flex justify-between mt-4">
                    <button onClick={goToPrevSlide} className="px-4 py-2 bg-[#E09145] text-white rounded">
                        Prev
                    </button>
                    <button onClick={goToNextSlide} className="px-4 py-2 bg-[#E09145] text-white rounded">
                        Next
                    </button>
                </div>
            </section>
