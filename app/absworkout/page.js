...
//       try {
//         const response = await axios.get('http://localhost:5000/api/abs-workouts');
...
//       <h1 className="text-3xl font-bold text-[#E09145] text-center mb-8">ABS Workout</h1>
...
//               <button className="bg-[#E09145] hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded">
//                 Start Workout
//               </button>
//             </div>
//           </div>
  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col items-center justify-center p-6">
        ...
        <h1 className="text-3xl font-bold text-[#E09145] text-center mb-8">ABS & Legs Workout</h1>
          ...
          {workoutData.map((workout, index) => (
            <div key={index} className="workout-card max-w-md bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="px-4 pb-4">
                <Link
                  href={{
                    pathname: '/absworkout-timer', // Path to your timer page
                    query: workout, // Pass workout data as query parameters
                  }}
                  className="bg-[#E09145p] hover:bg-orange-600  text-white font-semibold py-2 px-4 rounded"
                >
                  Start Workout
                </Link>
              </div>
