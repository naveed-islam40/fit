    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center m-14">
                <div className="flex flex-col md:flex-row p-6 space-x-6 max-w-6xl w-full bg-white rounded-3xl shadow-xl m-0">
...
export default ChestWorkoutTimer;
