    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 py-12">
      <section className="w-full max-w-3xl px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-[#E09145]">High-Calorie Meal Plan</h2>
                ...
                <div className="space-y-4">
                  {plan.meals.map((meal, i) => (
                    <div key={i} className="flex flex-col items-center space-y-2">
                      ...
                      <div className="text-gray-600">{meal.details} ({meal.calories} calories)</div>
                    </div>
                  ))}
                </div>
              </div>
...
export default HighCalorieMealPlan;
